...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Slider(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Slider).call(this, Slider, el, options));
      _this.el.M_Slider = _assertThisInitialized(_assertThisInitialized(_this));
      /**
