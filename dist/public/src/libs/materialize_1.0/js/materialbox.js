...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Materialbox(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Materialbox).call(this, Materialbox, el, options));
      _this.el.M_Materialbox = _assertThisInitialized(_assertThisInitialized(_this));
      /**
