...
(function ($) {
  ...
  function (_Component) {
    ...
    function CharacterCounter(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(CharacterCounter).call(this, CharacterCounter, el, options));
      _this.el.M_CharacterCounter = _assertThisInitialized(_assertThisInitialized(_this));
      /**
