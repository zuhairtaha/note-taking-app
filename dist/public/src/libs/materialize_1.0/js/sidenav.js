...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Sidenav(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Sidenav).call(this, Sidenav, el, options));
      _this.el.M_Sidenav = _assertThisInitialized(_assertThisInitialized(_this));
      ...
      Sidenav._sidenavs.push(_assertThisInitialized(_assertThisInitialized(_this)));
