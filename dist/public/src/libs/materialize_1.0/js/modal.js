...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Modal(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Modal).call(this, Modal, el, options));
      _this.el.M_Modal = _assertThisInitialized(_assertThisInitialized(_this));
      /**
