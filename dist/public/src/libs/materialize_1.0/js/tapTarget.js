...
(function ($) {
  ...
  function (_Component) {
    ...
    function TapTarget(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(TapTarget).call(this, TapTarget, el, options));
      _this.el.M_TapTarget = _assertThisInitialized(_assertThisInitialized(_this));
      /**
