...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Tabs(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Tabs).call(this, Tabs, el, options));
      _this.el.M_Tabs = _assertThisInitialized(_assertThisInitialized(_this));
      /**
