...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Dropdown(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Dropdown).call(this, Dropdown, el, options));
      _this.el.M_Dropdown = _assertThisInitialized(_assertThisInitialized(_this));

      Dropdown._dropdowns.push(_assertThisInitialized(_assertThisInitialized(_this)));
      ...
      _this._resetFilterQueryBound = _this._resetFilterQuery.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this._handleDocumentClickBound = _this._handleDocumentClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this._handleDocumentTouchmoveBound = _this._handleDocumentTouchmove.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this._handleDropdownClickBound = _this._handleDropdownClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this._handleDropdownKeydownBound = _this._handleDropdownKeydown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this._handleTriggerKeydownBound = _this._handleTriggerKeydown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
