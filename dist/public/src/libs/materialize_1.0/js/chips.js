...
(function ($) {
  ...
  function (_Component) {
    ...
    function Chips(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Chips).call(this, Chips, el, options));
      _this.el.M_Chips = _assertThisInitialized(_assertThisInitialized(_this));
      /**
