...
(function ($) {
  ...
  function (_Component) {
    ...
    function Carousel(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Carousel).call(this, Carousel, el, options));
      _this.el.M_Carousel = _assertThisInitialized(_assertThisInitialized(_this));
      /**
      ...
      _this._autoScrollBound = _this._autoScroll.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this._trackBound = _this._track.bind(_assertThisInitialized(_assertThisInitialized(_this))); // Full Width carousel setup
