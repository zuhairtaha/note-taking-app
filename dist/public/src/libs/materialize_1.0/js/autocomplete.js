...
(function ($) {
  ...
  function (_Component) {
    ...
    function Autocomplete(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Autocomplete).call(this, Autocomplete, el, options));
      _this.el.M_Autocomplete = _assertThisInitialized(_assertThisInitialized(_this));
      /**
