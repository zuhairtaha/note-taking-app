...
(function ($) {
  ...
  function (_Component) {
    ...
    function Timepicker(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Timepicker).call(this, Timepicker, el, options));
      _this.el.M_Timepicker = _assertThisInitialized(_assertThisInitialized(_this));
