...
(function ($) {
  ...
  function (_Component) {
    ...
    function Parallax(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Parallax).call(this, Parallax, el, options));
      _this.el.M_Parallax = _assertThisInitialized(_assertThisInitialized(_this));
      /**
      ...
      Parallax._parallaxes.push(_assertThisInitialized(_assertThisInitialized(_this)));
