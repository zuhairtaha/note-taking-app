...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Tooltip(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Tooltip).call(this, Tooltip, el, options));
      _this.el.M_Tooltip = _assertThisInitialized(_assertThisInitialized(_this));
