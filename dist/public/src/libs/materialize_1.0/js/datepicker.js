...
(function ($) {
  ...
  function (_Component) {
    ...
    function Datepicker(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Datepicker).call(this, Datepicker, el, options));
      _this.el.M_Datepicker = _assertThisInitialized(_assertThisInitialized(_this));
