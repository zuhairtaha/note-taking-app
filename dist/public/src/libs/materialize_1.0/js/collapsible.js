...
(function ($, anim) {
  ...
  function (_Component) {
    ...
    function Collapsible(el, options) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Collapsible).call(this, Collapsible, el, options));
      _this.el.M_Collapsible = _assertThisInitialized(_assertThisInitialized(_this));
      /**
